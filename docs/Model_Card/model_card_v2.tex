...
\begin{mcsection}{Detalhes do Modelo}
    \item Esse modelo (versão 2.0) foi desenvolvido por Luís Eduardo Limas Brito, XX/02/2026.
    ...
    \item Há implementação de dois modelos, a fim de comparação da qualidade dos resultados. Regressão linear (implementado usando "scikit-learn") e LightGBM (modelo criado Microsoft).
\end{mcsection}
